...
| 序号 | 变更类型 | 说明                          |         时间          | 备注         |
|:---|:-----|:----------------------------|:-------------------:|:-----------|
| 1  | F  | 修正 NPE 问题 | 2026-07-28 22:40:43 | NPE   |

# release_1.7.1

| 序号 | 变更类型 | 说明                          |         时间          | 备注         |
|:---|:-----|:----------------------------|:-------------------:|:-----------|
| 1  | U    | fastjson 升级为 fastjson2       | 2026-07-24 22:40:43 | 修复安全漏洞     |
| 2  | D    | 移除 deep-copy-fastjson 二方依赖  | 2026-07-24 22:40:43 | 内置 FastJson2 深度拷贝实现 |
