...
| 序号 | 变更类型 | 说明 | 时间 | 备注 |
|:---|:---|:---|:---|:---|
| 1 | F | 新增默认关闭的循环引用检测开关，启用后修复深度拷贝递归层级溢出 | 2026-08-01 | #21 |
| 2 | F | 修复多层嵌套空对象、空数组元素以及无字段上下文导致的空指针异常 | 2026-08-01 | #24、#25 |
| 3 | F | 修复基础类型集合脱敏时集合类型不兼容及数据丢失 | 2026-08-01 | #14 |
| 4 | T | 增加上述问题、开关默认值及循环检测器的回归测试与结果断言 | 2026-08-01 | 11 个场景 |
